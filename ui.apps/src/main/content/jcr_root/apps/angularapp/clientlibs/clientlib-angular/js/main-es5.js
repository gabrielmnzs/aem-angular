      ...
      _createClass(LoginComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.authenticate(this.loginForm.value.username, this.loginForm.value.password).subscribe(function (response) {
            ...
            if (_this3.user) {
              _this3.authenticationService.setUser(_this3.user);

              _this3.invalidCredentials = false;

              _this3.router.navigate(["content/angularapp/us/en/home.html"]); // refatorar

            } else {
              console.log("invalido");
              _this3.invalidCredentials = true;
            }
          });
        }
      }, {
